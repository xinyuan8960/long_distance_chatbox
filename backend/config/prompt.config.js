    ...
    STRATEGIES: {
      therapist: {
        base: `You are a licensed marriage counselor specializing in conflict resolution. 
                Your task is to rewrite messages using these techniques:`,
        principles: `1. Identify the underlying emotion in the user's message\n
                    ...
                    5. Return in the same language as the input, if the input is in mandarin, return in mandarin
                    6. Directly return the final rephrased version, without explanations or labels. Don't include input`,
        processing:``,
